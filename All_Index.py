...
TsFrames = [BillAmtMonthTs,BillAmtAvgMonthTs,BillAmtMaxMonthTs,BillAmtMinMonthTs,BillGapAvgMonthTs,BillGapMaxMonthTs,
          BillGapMinMonthTs,PayDayAvgMonthTs,PayDayMaxMonthTs,PayDayMinMonthTs,
          BillAmtWeekTs, BillAmtAvgWeekTs, BillAmtMaxWeekTs, BillAmtMinWeekTs, BillGapAvgWeekTs, BillGapMaxWeekTs,
          BillGapMinWeekTs, PayDayAvgWeekTs, PayDayMaxWeekTs, PayDayMinWeekTs,
          BillAmtQuaterTs, BillAmtAvgQuaterTs, BillAmtMaxQuaterTs, BillAmtMinQuaterTs, BillGapAvgQuaterTs, BillGapMaxQuaterTs,
          BillGapMinQuaterTs, PayDayAvgQuaterTs, PayDayMaxQuaterTs, PayDayMinQuaterTs,
          BillAmtYrTs, BillAmtAvgYrTs, BillAmtMaxYrTs, BillAmtMinYrTs, BillGapAvgYrTs, BillGapMaxYrTs,
          BillGapMinYrTs, PayDayAvgYrTs, PayDayMaxYrTs, PayDayMinYrTs]

names = ['BillAmtMonth','BillAmtAvgMonth','BillAmtMaxMonth','BillAmtMinMonth','BillGapAvgMonth','BillGapMaxMonth',
          'BillGapMinMonth','PayDayAvgMonth','PayDayMaxMonth','PayDayMinMonth',
          'BillAmtWeek', 'BillAmtAvgWeek', 'BillAmtMaxWeek', 'BillAmtMinWeek', 'BillGapAvgWeek', 'BillGapMaxWeek',
          'BillGapMinWeek', 'PayDayAvgWeek', 'PayDayMaxWeek', 'PayDayMinWeek',
          'BillAmtQuater', 'BillAmtAvgQuater', 'BillAmtMaxQuater', 'BillAmtMinQuater', 'BillGapAvgQuater', 'BillGapMaxQuater',
          'BillGapMinQuater', 'PayDayAvgQuater', 'PayDayMaxQuater', 'PayDayMinQuater',
          'BillAmtYr', 'BillAmtAvgYr', 'BillAmtMaxYr', 'BillAmtMinYr', 'BillGapAvgYr', 'BillGapMaxYr',
          'BillGapMinYr', 'PayDayAvgYr', 'PayDayMaxYr', 'PayDayMinYr']
...
TsIndexFrame = [BillAmtMonthIndex,BillAmtAvgMonthIndex,BillAmtMaxMonthIndex,BillAmtMinMonthIndex,BillGapAvgMonthIndex,BillGapMaxMonthIndex,
          BillGapMinMonthIndex,PayDayAvgMonthIndex,PayDayMaxMonthIndex,PayDayMinMonthIndex,
          BillAmtWeekIndex, BillAmtAvgWeekIndex, BillAmtMaxWeekIndex, BillAmtMinWeekIndex, BillGapAvgWeekIndex, BillGapMaxWeekIndex,
          BillGapMinWeekIndex, PayDayAvgWeekIndex, PayDayMaxWeekIndex, PayDayMinWeekIndex,
          BillAmtQuaterIndex, BillAmtAvgQuaterIndex, BillAmtMaxQuaterIndex, BillAmtMinQuaterIndex, BillGapAvgQuaterIndex, BillGapMaxQuaterIndex,
          BillGapMinQuaterIndex, PayDayAvgQuaterIndex, PayDayMaxQuaterIndex, PayDayMinQuaterIndex,
          BillAmtYrIndex, BillAmtAvgYrIndex, BillAmtMaxYrIndex, BillAmtMinYrIndex, BillGapAvgYrIndex, BillGapMaxYrIndex,
          BillGapMinYrIndex, PayDayAvgYrIndex, PayDayMaxYrIndex, PayDayMinYrIndex]
...
DrFrames = [BillAmtMonthDr,BillGapMonthDr,PayDayMonthDr,BillAmtQuaterDr,BillGapAvgQuaterDr,
            PayDayAvgQuaterDr, BillAmtWeekDr,BillGapAvgWeekDr,PayDayAvgWeekDr,BillAmtYrDr,BillGapAvgYrDr,PayDayAvgYrDr]

Drnames = ['BillAmtMonth','BillGapAvgMonth','PayDayAvgMonth','BillAmtWeek', 'BillGapAvgWeek',
           'PayDayAvgWeek','BillAmtQuater',  'BillGapAvgQuater','PayDayAvgQuater',
          'BillAmtYr','BillGapAvgYr', 'PayDayAvgYr']
